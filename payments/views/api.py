...
# from django_ratelimit.decorators import ratelimit  # Disabled - enable with Redis
...
# @method_decorator(ratelimit(key='ip', rate='10/m', method='POST'), name='post')  # Disabled - enable with Redis
...
# @method_decorator(ratelimit(key='ip', rate='20/m', method='GET'), name='get')  # Disabled - enable with Redis
